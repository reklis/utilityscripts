...
mycomputername=$1
scutil --set ComputerName $mycomputername
scutil --set HostName $mycomputername
scutil --set LocalHostName $mycomputername
defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string $mycomputername
...
# TURN OFF hitting the Backspace key to go to the previous page in history
